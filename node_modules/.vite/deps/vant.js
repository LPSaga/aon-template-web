...
var stdin_default6 = defineComponent({
  ...
  setup(props2, {
    ...
    const classPrefix = computed(() => props2.classPrefix || (config == null ? void 0 : config.iconPrefix) || bem4());
    return () => {
      const {
        tag,
        dot,
...
var stdin_default17 = defineComponent({
  ...
  setup(props2, {
    ...
    const offset2 = computed(() => unitToPx(props2.position === "top" ? props2.offsetTop : props2.offsetBottom));
...
var stdin_default20 = defineComponent({
  ...
  setup(props2, {
    ...
    }) : renderHeader() : null, createVNode(stdin_default19, {
      "ref": contentRef,
...
var stdin_default24 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderColumnItems = () => currentColumns.value.map((options, columnIndex) => createVNode(stdin_default15, {
    ...
    const renderToolbar = () => {
      if (props2.showToolbar && !parent) {
        return createVNode(stdin_default16, mergeProps(pick(props2, pickerToolbarPropKeys), {
          "onConfirm": confirm,
          "onCancel": cancel
    ...
    return () => {
      ...
      return createVNode(Form, {
        ...
        default: () => {
          ...
          }, null), [[vShow, props2.showArea]]), createVNode(stdin_default31, {
...
var stdin_default37 = defineComponent({
  ...
  setup(props2, {
    ...
    return () => createVNode(stdin_default36, mergeProps({
      "bem": bem33,
      "role": "radio",
      "parent": parent,
      "checked": checked(),
...
var stdin_default40 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderItem = (item, index, disabled) => {
      ...
      return createVNode(stdin_default39, {
        "key": item.id,
        "address": item,
        "disabled": disabled,
...
// node_modules/vant/es/barrage/index.mjs
...
var stdin_default44 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderDay = (item, index) => createVNode(stdin_default43, {
      "item": item,
      "index": index,
      "color": props2.color,
...
var stdin_default46 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderMonth = (date, index) => {
      ...
      return createVNode(stdin_default44, mergeProps({
...
var stdin_default56 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderContent = () => {
      ...
      return [createVNode("div", null, [`${t7("name")}：${props2.name}`]), createVNode("div", null, [`${t7("tel")}：${props2.tel}`])];
    };
    return () => createVNode(Cell, {
      "center": true,
...
function initInstance() {
  const Wrapper = {
    setup() {
      ...
      return () => createVNode(stdin_default65, mergeProps(state, {
        "onUpdate:show": toggle
      }), null);
    }
  };
  ...
  setup(props2, {
    ...
    return () => {
      const Content = withDirectives(createVNode("div", mergeProps({
        ...
        "style": rootStyle.value
      }, attrs), [slots.default ? slots.default() : createVNode(stdin_default7, {
        "name": props2.icon,
        "class": bem61("icon")
...
// node_modules/vant/es/floating-bubble/index.mjs
...
// node_modules/vant/es/highlight/index.mjs
...
var stdin_default75 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderImages = () => createVNode(Swipe, {
      ...
      default: () => [props2.images.map((image, index) => createVNode(stdin_default74, {
        "ref": (item) => {
...
function initInstance2() {
  ({
    ...
    setup() {
      ...
      return () => createVNode(stdin_default75, mergeProps(state, {
        "onClosed": onClosed,
        "onUpdate:show": toggle
      }), null);
    }
...
function initInstance3() {
  ({
    ...
    setup() {
      ...
      return () => createVNode(stdin_default81, mergeProps(state, {
        "onUpdate:show": toggle
      }), null);
    }
  }));
...
var stdin_default83 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderKeys = () => keys.value.map((key) => {
      ...
      return createVNode(stdin_default82, {
        "key": key.text,
        "text": key.text,
        "type": key.type,
        "wider": key.wider,
    ...
    const renderSidebar = () => {
      if (props2.theme === "custom") {
        return createVNode("div", {
          "class": bem75("sidebar")
        }, [props2.showDeleteKey && createVNode(stdin_default82, {
          "large": true,
...
var stdin_default91 = defineComponent({
  ...
  setup(props2) {
    ...
    return () => createVNode("div", {
      "class": bem83()
    }, [targetNumArr.value.map((_, i) => createVNode(stdin_default90, {
...
// node_modules/vant/es/signature/index.mjs
...
var stdin_default103 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderAvatar = () => {
      if (props2.avatar) {
        return createVNode(stdin_default100, {
    ...
    const renderTitle = () => {
      if (props2.title) {
        return createVNode(stdin_default98, {
          "round": props2.round,
    ...
    const renderRows = () => Array(+props2.row).fill("").map((_, i) => createVNode(stdin_default102, {
      "key": i,
      "round": props2.round,
  ...
  setup(props2, {
    ...
    const renderText = () => {
      ...
      if (typeof price === "number") {
        ...
        }, [createVNode("span", null, [label || t20("label")]), createVNode("span", {
          "class": bem99("price")
...
var stdin_default111 = defineComponent({
  name: name104,
...
var stdin_default112 = defineComponent({
  name: name105,
  props: tabbarProps,
  emits: ["change", "update:modelValue"],
  setup(props2, {
...
var stdin_default113 = defineComponent({
  name: name106,
...
var stdin_default114 = defineComponent({
  name: name107,
...
var stdin_default115 = defineComponent({
  name: name108,
...
var stdin_default116 = defineComponent({
  name: name109,
...
var stdin_default118 = defineComponent({
  name: name110,
  props: uploaderProps,
  ...
  setup(props2, {
    ...
    const renderPreviewItem = (item, index) => {
      ...
      return createVNode(stdin_default117, mergeProps({
        "item": item,
        "index": index,
...
var stdin_default119 = defineComponent({
  name: name111,
