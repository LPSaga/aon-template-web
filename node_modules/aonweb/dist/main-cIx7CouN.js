...
var Y = 0, he = 1, re = 2, j = 3, Q = 4, ce = 5, Me = 6, on = 7, ln = 8;
m("Y", 0, 0, function() {
  var t = this.year();
...
function Rs(t) {
  var e, s, r = [], i, n, a;
  if (!t._d) {
    for (i = ma(t), t._w && t._a[re] == null && t._a[he] == null && ya(t), t._dayOfYear != null && (a = Ye(t._a[Y], i[Y]), (t._dayOfYear > st(a) || t._dayOfYear === 0) && (g(t)._overflowDayOfYear = !0), s = at(a, 0, t._dayOfYear), t._a[he] = s.getUTCMonth(), t._a[re] = s.getUTCDate()), e = 0; e < 3 && t._a[e] == null; ++e)
      t._a[e] = r[e] = i[e];
    for (; e < 7; e++)
      t._a[e] = r[e] = t._a[e] == null ? e === 2 ? 1 : 0 : t._a[e];
    t._a[j] === 24 && t._a[Q] === 0 && t._a[ce] === 0 && t._a[Me] === 0 && (t._nextDay = !0, t._a[j] = 0), t._d = (t._useUTC ? at : Sn).apply(
      null,
      r
...
function ya(t) {
  ...
  e = t._w, e.GG != null || e.W != null || e.E != null ? (n = 1, a = 4, s = Ye(
    ...
    t._a[Y],
    ot(x(), 1, 4).year
  ), r = Ye(e.W, 1), i = Ye(e.E, 1), (i < 1 || i > 7) && (l = !0)) : (n = t._locale._week.dow, a = t._locale._week.doy, h = ot(x(), n, a), s = Ye(e.gg, t._a[Y], h.year), r = Ye(e.w, h.week), e.d != null ? (i = e.d, (i < 0 || i > 6) && (l = !0)) : e.e != null ? (i = e.e + n, (e.e < 0 || e.e > 6) && (l = !0)) : i = n), r < 1 || r > fe(s, n, a) ? g(t)._overflowWeeks = !0 : l != null ? g(t)._overflowWeekday = !0 : (o = Mr(s, r, i, n, a), t._a[Y] = o.year, t._dayOfYear = o.dayOfYear);
}
_.ISO_8601 = function() {
};
_.RFC_2822 = function() {
...
function Yr(t, e, s, r, i) {
  var n = {};
  return (e === !0 || e === !1) && (r = e, e = void 0), (s === !0 || s === !1) && (r = s, s = void 0), (Ae(t) && ys(t) || X(t) && t.length === 0) && (t = void 0), n._isAMomentObject = !0, n._useUTC = n._isUTC = i, n._l = s, n._i = t, n._f = e, n._strict = r, ba(n);
}
function x(t, e, s, r) {
  return Yr(t, e, s, r, !1);
}
...
var Ol = xe("milliseconds"), Dl = xe("seconds"), Pl = xe("minutes"), El = xe("hours"), Ml = xe("days"), Al = xe("months"), xl = xe("years");
function Rl() {
  return H(this.days() / 7);
}
var ue = Math.round, Ue = {
  ss: 44,
...
function Il(t, e) {
  return Ue[t] === void 0 ? !1 : e === void 0 ? Ue[t] : (Ue[t] = e, t === "s" && (Ue.ss = e - 1), !0);
}
function Yl(t, e) {
  if (!this.isValid())
    return this.localeData().invalidDate();
  var s = !1, r = Ue, i, n;
  return typeof t == "object" && (e = t, t = !1), typeof t == "boolean" && (s = t), typeof e == "object" && (r = Object.assign({}, Ue, e), e.s != null && e.ss == null && (r.ss = e.s - 1)), i = this.localeData(), n = $l(this, !s, r, i), s && (n = i.pastFuture(+this, n)), i.postformat(n);
}
var Zt = Math.abs;
function Ce(t) {
  return (t > 0) - (t < 0) || +t;
...
class Ou {
  ...
  connect() {
    if (!this.conn) {
      ...
      }), import("./browser-BnVAVYqw.js").then((e) => e.b).then(({ default: e }) => {
...
const Nu = { "X-Client-Info": `supabase-js-${et}/${Uu}` }, Fu = {
  headers: Nu
}, Wu = {
  schema: "public"
}, Hu = {
...
const xi = "https://api.iaon.ai", Ri = jh, A = Ai(xi, Ri);
...
class qh {
  ...
  async list(e) {
    ...
    if (!e)
      throw new Error("User not login");
    const { data: i, error: n } = await A.from("exec_task").select("*").is("deleted_at", null).eq("user_id", e).eq("app_key", r).eq("status", 2).order("created_at", { ascending: !1 });
    if (n) throw n;
    return i;
  }
}
